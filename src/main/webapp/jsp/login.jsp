...
<body class="bodyBackground">
	<div class="container">
		<div class="col-lg-4 col-lg-offset-4 col-sm-6 col-sm-offset-3 col-xs-8 col-xs-offset-2" style="margin-top: 100px">
			<form method="post" action="/web/login">
				...
				<div class="panel-body ">
					...
					<div class="input-group col-sm-12">
						<input type="text" class="form-control alpha whiteFont" placeholder="Username" name="userName" value="${userName}">
					</div>
					...
					<button type="submit" class="btn btn-default btn-block pFont">登录</button>
				</div>
			</form>
